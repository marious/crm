<template>
    <app-modal modal-id="product-brand-modal" modal-size="default" modal-alignment="top"
               @close-modal="closeModal">

        <template slot="header">
            <h5 class="modal-title">
                {{ selectedUrl ? $t('edit') : $t('add') }} {{ $t('product_brand') }}
            </h5>
        ...
        <template slot="body">
            <form ref="form" :data-url='selectedUrl ? selectedUrl : `crm/product/brands`'>
